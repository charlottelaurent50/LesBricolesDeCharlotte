 ...
 */
final class Version20230104121939 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE patron_creation (patron_id INT NOT NULL, creation_id INT NOT NULL, INDEX IDX_E1443CEA34FFA69A (creation_id), INDEX IDX_E1443CEADBD5322 (patron_id), PRIMARY KEY(patron_id, creation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
